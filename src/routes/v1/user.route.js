...
const { checkUserAction } = require('../../middlewares/validateAction');
...
router.post('/reset-password', validate(userValidation.resetPassword), userController.resetPassword);
...
router.post('/update-contact-no-verify', validate(userValidation.updateContactByEmail), userController.updateContactByEmail);
